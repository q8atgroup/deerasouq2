                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectric" name="campaign" id="campaign">
                                                ...
                                                @foreach(\App\Models\Campaign::where('status', 1)->get() as $campaign)
                                                    <option
                                                            value="{{ $campaign->id }}" {{ old('campaign') == $campaign->id ? 'selected' : '' }}>{{ $campaign->getTranslation('title', App::getLocale()) }}</option>
                                                @endforeach
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control selectric" name="campaign_discount_type"
                                                        ...
                                                        <option
                                                                value="flat" {{ old('campaign_discount_type') == 'flat' ? 'selected' : ''}}>{{ __('Flat') }}</option>
                                                        <option
                                                                value="percentage" {{ old('campaign_discount_type') == 'percentage' ? 'selected' : ''}}>{{ __('Percent') }}</option>
                                                    </select>
